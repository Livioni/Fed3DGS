...
class HashEncoding(nn.Module):
    r"""Hash Grid Encoding used in Instant-NGP.
...
class GaussianModel:
    ...
    def __init__(self, sh_degree : int, use_img_feats: bool = True):
    ...
    def create_from_pcd(self, pcd : BasicPointCloud, spatial_lr_scale : float, logger = None):
        ...
        if logger:
            logger.info("Number of points at initialisation : {}".format(fused_point_cloud.shape[0]))
    ...
    def training_setup(self, training_args):
        ...
        self.xyz_scheduler_args = get_linear_lr_func(lr_init=training_args.position_lr_init,
                                                     lr_final=training_args.position_lr_final,
                                                     start_decay_step=training_args.position_lr_decay_steps,
                                                     max_steps=training_args.position_lr_max_steps)
